...
function Usersidebar() {
  ...
  return (
    <div className="poppins flex flex-col md:flex-row min-h-screen bg-zinc-200">
      ...
      {!isSidebarOpen && (
        <div className="w-full h-20 md:hidden bg-white flex items-center justify-between px-4">
          {/* <img className="h-[8vh] w-1/2 object-cover" src={logo.png} alt="Logo" /> */}
      ...
      >
        <button
          className="lg:hidden mt-2 text-black rounded "
          onClick={() => setIsSidebarOpen(!isSidebarOpen)}
        >
          <RxCross1 className="font-thin" />
        </button>
        {/* Logo */}
        <div className="rounded-md p-3 mt-2 flex items-center justify-center h-18  ">
          <img src="img/logo.png" alt="Logo" className="max-h-full" />
        </div>
        ...
        <div className="flex flex-col gap-4 mt-16">
          <button 
          onClick={handleAllNotifications}
          className="px-1 py-2 text-center bg-gray-200 text-black rounded hover:bg-blue-600 hover:text-white duration-300 flex justify-evenly items-center">
            <FaBell className="font-bold text-xl" />
            All Notifications
          </button>
          <button
            onClick={handleMarkAttendance}
            className="px-4 py-2 text-center  bg-gray-200 text-black rounded hover:bg-blue-600 tracking-tighter hover:text-black duration-300 flex justify-evenly items-center"
          >
            <IoMdCheckmarkCircleOutline className="font-bold text-xl" />
            Mark Attendance
          </button>
          <button
            onClick={Myattendance}
            className="px-4 py-2 text-center  bg-gray-200 text-black rounded hover:bg-blue-600 hover:text-black tracking-tighter  duration-300 flex justify-evenly items-center"
          >
            <RiShieldUserLine className="text-xl" />
            My Attendances
          </button>
          <button
            onClick={handleLeaveStatus}
            className="px-4 py-2 text-center  bg-gray-200 text-black rounded hover:bg-blue-600 hover:text-black duration-300 flex justify-evenly items-center gap-3"
          >
            <BiSolidCalendarExclamation className="font-bold text-xl" />
            Leave Status
          </button>
